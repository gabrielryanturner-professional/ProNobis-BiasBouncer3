...
def render_edit_dialog():
    ...
    def show_edit_dialog():
        ...
        with col1:
            ...
            st.text_area("Description", value=agent["description"], key=f"edit_{agent_index}_description", height=200, on_change=handle_agent_detail_change, args=(agent_index, "description"))
